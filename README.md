...
> Be patient! In ~3 mins your app is live, at your [app url](https://container---e7fym.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container---e7fym.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container---e7fym.git
cd container---e7fym
```
